namespace FirstHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerDetailsCountRepository Getvw_CustomerDetailsCountRepository()
		{
			var repository = new vw_CustomerDetailsCountRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerDetailsCountRepository Getvw_CustomerDetailsCountRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerDetailsCountRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
